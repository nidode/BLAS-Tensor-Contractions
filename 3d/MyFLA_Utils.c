...
// ============================================================================
// Zero the strictly lower triangular part of a matrix, excluding the diagonal.
...
// ============================================================================
// Zero the strictly upper triangular part of a matrix, excluding the diagonal.
...
int MyFLA_Set_strict_lower_triangular_to_float( FLA_Obj A, float value ) {
  ...
  default:
    fprintf( stderr, "+++ ERROR in MyFLA_Set_strict_lower_triangular_to_float:  " );
    fprintf( stderr, "Datatype not implemented: %d\n", FLA_Obj_datatype( A ) );
  }
...
int MyFLA_Set_strict_lower_triangular_to_double( FLA_Obj A, double value ) {
  ...
  default:
    fprintf( stderr, "+++ ERROR in MyFLA_Set_strict_lower_triangular_to_double:  " );
    fprintf( stderr, "Datatype not implemented: %d\n", FLA_Obj_datatype( A ) );
  }
...
int MyFLA_Set_strict_upper_triangular_to_float( FLA_Obj A, float value ) {
  ...
  default:
    fprintf( stderr, "+++ ERROR in MyFLA_Set_strict_upper_triangular_to_float:  " );
    fprintf( stderr, "Datatype not implemented: %d\n", FLA_Obj_datatype( A ) );
  }
...
int MyFLA_Set_strict_upper_triangular_to_double( FLA_Obj A, double value ) {
  ...
  default:
    fprintf( stderr, "+++ ERROR in MyFLA_Set_strict_upper_triangular_to_double:  " );
    fprintf( stderr, "Datatype not implemented: %d\n", FLA_Obj_datatype( A ) );
  }
  ...
  case FLA_FLOAT:
    {
      ...
      for ( j = 0; j < n_A; j++ ) {
        for ( i = 0; i < m_A; i++ ) {
          buff_A[ i * rs_A + j * cs_A ] = my_abs( buff_A[ i * rs_A + j * cs_A ]);
        }
      }
    }
    break;
  ...
  case FLA_FLOAT:
    {
      ...
      MyFLA_Nrm1( A, norm1 );
      FLA_Shift_diag( FLA_NO_TRANSPOSE, norm1, A );
